package ojk.animation.portfolio.youtubedemo
...
import ojk.animation.portfolio.youtubedemo.YouTubeDemoViewHolder.*
...
class FrontPhotosAdapter : RecyclerView.Adapter<YouTubeDemoViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): YouTubeDemoViewHolder {
        ...
        return when (viewType) {
            R.layout.motion_24_recyclerview_expanded_text_header -> TextHeaderViewHolder(
                itemView
            )
